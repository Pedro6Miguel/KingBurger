...
import Burger7 from '../../assets/img/Burger1.png'
import Burger8 from '../../assets/img/Burger2.png'

export default [Burger1, Burger2, Burger3, Burger4, Burger5, Burger6, Burger7, Burger8]